...
class QuizBrain{
  ...
  // objects made from questions class
...
void increaseQNumber(){
  if(_questionNumber < _questions.length-1){
    _questionNumber++;
  }
}
  // getter function for question Text
  String getQuestionText( ){
    return _questions[_questionNumber].questionText;
  }
  // getter function for question Answer
  bool getQuestionAnswer( ){
    return _questions[_questionNumber].questionAnswer;
  }

  // checking the end of the questions
  bool isFinished(){
  if(_questionNumber >= _questions.length-1){
    return true;
  }
  ...
  // resetting question number
void resettingQNumber(){
    _questionNumber = 0;
}
}